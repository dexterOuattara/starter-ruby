...
class MycategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mycategory" do
    assert_difference('Mycategory.count') do
      post mycategories_url, params: { mycategory: { content: @mycategory.content, title: @mycategory.title } }
    end
  ...
  test "should update mycategory" do
    patch mycategory_url(@mycategory), params: { mycategory: { content: @mycategory.content, title: @mycategory.title } }
